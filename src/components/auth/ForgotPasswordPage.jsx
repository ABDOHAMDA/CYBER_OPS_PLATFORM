          ...
          <div className="bg-gray-800/90 backdrop-blur-lg rounded-lg shadow-2xl overflow-hidden border border-green-500/30">
            <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 p-8 text-center relative overflow-hidden border-b border-green-500/30">
              ...
              <div className="relative z-10">
                ...
                <h1 className="text-3xl font-bold text-green-400 mb-2 font-mono">RECOVERY_SENT</h1>
                <p className="text-gray-400 font-mono text-sm">ACCESS_RECOVERY_INITIATED</p>
              </div>
            </div>

            <div className="p-8 text-center">
              <div className="mb-6">
                <h2 className="text-2xl font-bold text-white mb-4 font-mono">RECOVERY_PROTOCOL_ACTIVE</h2>
                <p className="text-gray-400 font-mono mb-2 text-center">
                  ACCESS_RECOVERY_INSTRUCTIONS_SENT_TO:
                </p>
                <p className="text-green-400 font-mono font-semibold break-all">{email}</p>
              </div>
        ...
        <div className="bg-gray-800/90 backdrop-blur-lg rounded-lg shadow-2xl overflow-hidden border border-orange-500/30">
          <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 p-8 text-center relative overflow-hidden border-b border-orange-500/30">
            ...
            <div className="relative z-10">
              ...
              <h1 className="text-3xl font-bold text-orange-400 mb-2 font-mono">ACCESS_RECOVERY</h1>
              <p className="text-gray-400 font-mono text-sm">OPERATIVE_IDENTITY_RECOVERY</p>
            </div>
          </div>

          <div className="p-8">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-white mb-2 font-mono">RECOVER_ACCESS</h2>
              <p className="text-gray-400 font-mono text-center">ENTER_OPERATIVE_IDENTIFIER</p>
            </div>
            ...
            <div className="mt-6 bg-gray-700/50 backdrop-blur-sm border border-orange-500/30 rounded-lg p-4">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <p className="font-semibold text-white text-sm font-mono">SECURE_RECOVERY</p>
              </div>
